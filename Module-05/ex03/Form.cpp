...
/*   Updated: 2022/09/16 11:19:44 by klaarous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	Form::isValidToExecute(Bureaucrat const & executor) const
{
	return (_isSigned && executor.getGrade() <= this->getSignGrade() && executor.getGrade() <= this->getExecuteGrade());
}
